...
public class FormCadAluno extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Dados Cadastrais do Aluno"));
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        a.setDataNascimento(Date.valueOf(strdataformat));
        //sexo
        ...
        if (textobotao.equalsIgnoreCase("cadastrar")) {
            boolean cadastrou = AlunoControle.Cadastrar(a);
            if (cadastrou) {
                txtNome.setText("");
